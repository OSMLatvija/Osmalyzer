...
[UsedImplicitly]
public class LatviaPostLockerAnalyzer : Analyzer
{
    protected string Operator { get; } = "Latvia Post";

    protected List<string> ParcelLockerOsmNames { get; } = new () { "Latvijas Pasts", "Pasta Stacija", "PastaStacija" };
    ...
    public override void Run(IReadOnlyList<AnalysisData> datas, Report report)
    {
        ...
        Correlator<LatviaPostItem> dataComparer = new Correlator<LatviaPostItem>(
            brandLockers,
            listedItems.Where(_ => _.ItemType == LatviaPostItemType.ParcelLocker).ToList(),
